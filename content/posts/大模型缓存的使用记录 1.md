...
![](assets/Pasted%20image%2020241130095709.png)
...
## 开源方案-ModelCache
项目结构如下：
![](assets/Pasted%20image%2020241130100849.png)
...
![](assets/Pasted%20image%2020241130104151.png)
...
`modelcache/manager/scalar_data/sql_storage.py`
![](assets/Pasted%20image%2020241130105116.png)

在前面的demo中同样存在这个问题：
`modelcache/manager/scalar_data/sql_storage_sqlite.py`
![](assets/Pasted%20image%2020241130105155.png)
